...
import { availableModels, getModelConfig } from "@/lib/modelConfig";
      ...
      <div className="p-4 border-b border-neutral-200">
        ...
        {visibleModels.map((model) => {
          ...
          return (
            <button 
              key={model.id}
              className={`flex items-center w-full p-2 mb-2 rounded-md text-left hover:bg-neutral-100 transition-colors group ${
                isActive ? `bg-${model.color}-50 border border-${model.color}-200` : ''
              }`}
        ...
        {availableModels.length > 5 && (
          <button 
            className="flex items-center w-full p-2 text-sm text-neutral-600 hover:text-primary transition-colors"
